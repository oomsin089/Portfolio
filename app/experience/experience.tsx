  ...
  const experiences = [
    {
      ...
      period: "7 Months",
      description:
        "พัฒนาเว็บไซต์และแอปพลิเคชันโดยใช้ Next.js และ Kotlin Spring Boot ทำงานร่วมกับทีมในการปรับปรุง BA ได้พัฒนาระบบแจ้งปัญหาที่ประกอบด้วย แบบฟอร์มแจ้งปัญหา การอัปเดตสถานะ ฟีเจอร์ส่งออกไฟล์ PDF และ Excel รวมถึงไทม์ไลน์ที่แสดงความคืบหน้าของปัญหาที่แจ้ง นอกจากนี้ ระบบยังรวมข้อตกลงระดับบริการ (SLA) โดยเน้นที่เวลาตอบสนองและเวลาแก้ไขปัญหาโดยเฉพาะ",
      skills: [
        "React",
        "Next.js",
        "TypeScript",
